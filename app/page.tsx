            ...
            <div className="relative">
              ...
              <div className="relative min-h-[460px] overflow-hidden rounded-[30px] border border-white/[0.08] bg-[#0b0d0e]">
                ...
                <div className="relative flex min-h-[330px] items-center justify-center">
                  ...
                  {/* STORE ONLINE */}
                  <div className="absolute right-6 top-14 rounded-xl border border-white/[0.08] bg-black/70 px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl transition hover:border-lime-400/30">
                  ...
                  {/* SECURE PURCHASE */}
                  <div className="absolute bottom-14 left-6 rounded-xl border border-white/[0.08] bg-black/70 px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl transition hover:border-lime-400/30">
                  ...
                  {/* DIGITAL DELIVERY */}
                  <div className="absolute bottom-28 right-6 rounded-xl border border-white/[0.08] bg-black/70 px-4 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.25)] backdrop-blur-xl transition hover:border-lime-400/30">
